...
if __name__ == "__main__":
    ...
    hidden_indices = [0, 1, 3, 4, 5, 7, 8, 9, 10, 11]
    possible_backgrounds = [None, 3, 4, 7, 8, 9, 10, 11]
    ...
    for bg_element_idx in possible_backgrounds:
        ...
        fname = 'neuromorphic_fig4_bg%s_big_mip.pickle' % bg_element_idx
